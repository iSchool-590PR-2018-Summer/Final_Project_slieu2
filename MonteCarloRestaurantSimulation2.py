...
def data_init():
    ...
    certain profitability/loss. If the desired profitability/loss is not desirable, then, they can be
    tweaked before running a new simulation
    :return:
    """
    # TBD - tweak base cost, base time, hoursly rates, menu price
...
def salary_data_init(position_name, hourly_rate_base, peak_hours_factor):
    ...
    The employe salary is a parameter in our model that can be adjusted across simulations to see how it impacts the
...
def monte_carlo_simulation(iterations):
    """
    This function is the engine of the monte carlo simulation for our restaurant model. It will run the simulation
    on
...
def random_dish_cost_base(dish_name):
    """
    This function applies a random factor to a dish base cost
    :param dish_name:
    :return:
    """
    cost = 0
...
if __name__ == '__main__':
    ...
    # 3. Do the analysis of the results and capture the analysis results in a CVS format
    data_init()
